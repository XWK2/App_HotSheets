...
{
    public abstract class ShippingInstructionsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ShippingInstructionsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ShippingInstructionsWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<ShippingInstructionsDbContext> action)
        {
            using (var context = IocManager.Resolve<ShippingInstructionsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<ShippingInstructionsDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<ShippingInstructionsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ShippingInstructionsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ShippingInstructionsDbContext, Task<T>> func)
        {
            T result;
