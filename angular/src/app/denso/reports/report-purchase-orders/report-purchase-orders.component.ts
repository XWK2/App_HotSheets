...
@Component({
    selector: 'report-purchase-orders',
    templateUrl: './report-purchase-orders.component.html',
    styleUrls: ['./report-purchase-orders.component.css'],
    animations: [appModuleAnimation()],
})
export class PurchaseOrdersReportsComponent extends AppComponentBase implements OnInit {
