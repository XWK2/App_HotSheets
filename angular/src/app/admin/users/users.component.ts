...
export class UsersComponent extends PagedListingComponentBase<UserDto> {
    ...
    constructor(injector: Injector, private _userService: UserServiceProxy, private _modalService: BsModalService) {
        super(injector);
    }
    ...
    public getDepartmentNames(deptosByUser: DepartmentUserDto[]): string {
        return deptosByUser.map((du) => du.departmentName).join(', ');
    }

    public getPlantNames(plantsByUser: PlantUserDto[]): string {
        return plantsByUser.map((du) => du.plantName).join(', ');
    }
}
