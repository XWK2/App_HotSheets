...
export class RolesComponent extends PagedListingComponentBase<RoleDto> {
    ...
    constructor(injector: Injector, private _rolesService: RoleServiceProxy, private _modalService: BsModalService) {
        super(injector);
    }

    public list(request: PagedRolesRequestDto, pageNumber: number, finishedCallback: Function): void {
    ...
    public delete(role: RoleDto): void {
    ...
    public editRole(role: RoleDto): void {
        this.showCreateOrEditRoleDialog(role.id);
    }

    public showCreateOrEditRoleDialog(id?: number): void {
