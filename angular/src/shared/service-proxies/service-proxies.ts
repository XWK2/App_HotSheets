...
export class StarSheetsDto implements IStarSheetsDto {
    ...
    dateSearch: number;
    orderQty: number;
    deliveryOrder: string | undefined;
    delQty: number;
    asn: string | undefined;
    inTransitQty: number;
    aDate: number;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.partNumber = _data["partNumber"];
            this.partDescription = _data["partDescription"];
            this.dateSearch = _data["dateSearch"];
            this.orderQty = _data["orderQty"];
            this.deliveryOrder = _data["deliveryOrder"];
            this.delQty = _data["delQty"];
            this.asn = _data["asn"];
            this.inTransitQty = _data["inTransitQty"];
            this.aDate = _data["aDate"];
            this.rcvd = _data["rcvd"];
            this.dueDate = _data["dueDate"];
            this.receivedQty = _data["receivedQty"];
            this.container = _data["container"];
            this.stock1 = _data["stock1"];
            this.stock2 = _data["stock2"];
            this.pcComments = _data["pcComments"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["partNumber"] = this.partNumber;
        data["partDescription"] = this.partDescription;
        data["dateSearch"] = this.dateSearch;
        data["orderQty"] = this.orderQty;
        data["deliveryOrder"] = this.deliveryOrder;
        data["delQty"] = this.delQty;
        data["asn"] = this.asn;
        data["inTransitQty"] = this.inTransitQty;
